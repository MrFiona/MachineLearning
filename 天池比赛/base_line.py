...
test = pd.read_csv('d_test_A_20180102.csv')
...
def make_feat(train, test):
    ...
    print 'www:\t', columns_list
    data[columns_list[28]] = data[columns_list[28]].map({'男': 1, '女': 0})
    data[columns_list[27]] = (pd.to_datetime(data[columns_list[27]]) - parse('2017-10-09')).dt.days
